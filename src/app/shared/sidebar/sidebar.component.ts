...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Sách',url:'',icon:'signal',childs:[{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý chủ đề',url:'/product/type'},{name:'Quản lý sách',url:'/product/product'},{name:'Quản lý nhà xuất bản',url:'/product/nxb'}]}];
  constructor() { } 
  ngOnInit(): void {
  }
  ngAfterViewInit() {
